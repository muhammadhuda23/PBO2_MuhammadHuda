...
public class Contact extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("TMPLAHIR");

        jLabel4.setText("TGLLAHIR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new dbCRUD().SimpanDinamiscContact(NIP.getText(), NAMA.getText(), TMPLAHIR.getText(), TGLLAHIR.getText(), JENKEL.getText() ,STATUS.getText() ,AGAMA.getText() ,ALAMAT.getText() ,,TELP.getText());
